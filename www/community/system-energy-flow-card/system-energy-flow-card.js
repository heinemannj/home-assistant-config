 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */()],yt.prototype,"_config",void 0),t([lt("#battery-grid-flow")],yt.prototype,"batteryGridFlow",void 0),t([lt("#battery-home-flow")],yt.prototype,"batteryToHomeFlow",void 0),t([lt("#grid-home-flow")],yt.prototype,"gridToHomeFlow",void 0),t([lt("#solar-battery-flow")],yt.prototype,"solarToBatteryFlow",void 0),t([lt("#solar-grid-flow")],yt.prototype,"solarToGridFlow",void 0),t([lt("#solar-home-flow")],yt.prototype,"solarToHomeFlow",void 0),yt=t([(t=>e=>"function"==typeof e?((t,e)=>(window.customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:i,elements:r}=e;return{kind:i,elements:r,finisher(e){window.customElements.define(t,e)}}})(t,e))("system-energy-flow-card")],yt);const ft=window;ft.customCards=ft.customCards||[],ft.customCards.push({type:"system-energy-flow-card",name:"System Energy Flow Card",description:"A power distribution card inspired by the official Energy Distribution card for Home Assistant"});export{yt as SystemEnergyFlowCard};
